...
use ArangoDb\Http\Uri;

/**
 * Code is largely lifted from the ZendTest\Diactoros\RequestTest implementation in
...
class RequestTest extends TestCase
{
    ...
    public function testConstructorRaisesExceptionForInvalidStream()
    {
        ...
        new Request(null, ['TOTALLY INVALID']);
    }
    ...
    {
        $request = (new Request('GET', 'http://example.com'))->withoutHeader('host');
        $headers = $request->getHeaders();
        $this->assertArrayHasKey('Host', $headers);
        $this->assertContains('example.com', $headers['Host']);
    }
    ...
    {
        $request = new Request(null, 'http://www.example.com');
    ...
    {
        $request = new Request(null, 'http://www.example.com',  ['Host' => 'www.test.com'], 'php://memory');
