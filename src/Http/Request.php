 ...
 *
 * Code is largely lifted from the Zend\Diactoros\Request implementation in
...
final class Request implements RequestInterface
{
     ...
     */
    public function __construct(string $method = null, $uri = null, array $headers = [], $body = 'php://temp')
    {
